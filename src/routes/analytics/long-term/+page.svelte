...
<div class="container mx-auto p-4 space-y-4">
    <h1 class="h1">Long-Term Analytics</h1>
    ...
    {#if data.hasData}
        <Accordion {value} onValueChange={(e) => (value = e.value)} collapsible>
            <Accordion.Item value='workoutPerformance'>
                ...
                {/snippet}
                {#snippet control()}
                    <h3 class="h3">Workout Performance Trends</h3>
                {/snippet}
                {#snippet panel()}
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 p-4">
                        ...
                        {:else}
                            <div class='card p-4'><p class="p-4 text-center">No Volume data available.</p></div>
                        {/if}
                        ...
                        {:else}
                            <div class='card p-4'><p class="p-4 text-center">No Stimulus data available.</p></div>
                        {/if}
                        ...
                        {:else}
                            <div class='card p-4'><p class="p-4 text-center">No Fatigue data available.</p></div>
                        {/if}
                        ...
                        {:else}
                            <div class='card p-4'><p class="p-4 text-center">No SFR data available.</p></div>
                        {/if}
                    </div>
                {/snippet}
            </Accordion.Item>
            ...
            <Accordion.Item value='subjectiveFeedback'>
                ...
                {#snippet panel()}
                     <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 p-4">
                        ...
                        {:else}
                            <div class='card p-4'><p class="p-4 text-center">No Burn data available.</p></div>
                        {/if}
                        ...
                        {:else}
                            <div class='card p-4'><p class="p-4 text-center">No Pump data available.</p></div>
                        {/if}
                        ...
                        {:else}
                            <div class='card p-4'><p class="p-4 text-center">No Difficulty data available.</p></div>
                        {/if}
                        ...
                        {:else}
                            <div class='card p-4'><p class="p-4 text-center">No Soreness data available.</p></div>
                        {/if}
                        ...
                        {:else}
                            <div class='card p-4'><p class="p-4 text-center">No Joint Pain data available.</p></div>
                        {/if}
                     </div>
                {/snippet}
            </Accordion.Item>
